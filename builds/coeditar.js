...
// Manage the exports of the entire framework to avoid circular references
       * from './data/serialization/Serializable.js';
       * from './data/serialization/Serialization.js';
       * from './data/serialization/serializers/JsonSerializer.js';
// export * from './data/serialization/XmlSerializer'
       * from './data/localization/Locale.js';
       * from './data/localization/LocalizedString.js';
       * from './logic/Expression.js';
       * from './logic/Context.js';
       * from './logic/Event.js';
       * from './logic/semantic/Domain.js';
       * from './logic/semantic/Class.js';
       * from './logic/semantic/Property.js';
       * from './logic/semantic/Relation.js';
       * from './logic/semantic/Instance.js';
       * from './logic/semantic/Metadata.js';
       * from './data/Node.js';
       * from './data/Link.js';
       * from './data/modelling/ModelNode.js';
       * from './data/modelling/ClassNode.js';
       * from './data/modelling/PropertyNode.js';
       * from './data/types/basic/BooleanNode.js';
       * from './data/types/basic/NumberNode.js';
       * from './data/types/basic/StringNode.js';
       * from './data/types/VectorNode.js';
