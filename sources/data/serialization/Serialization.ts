...
export class Serialization {
	 ...
	 * @returns validates */
	static isLetter(char: string) { return RegExp(/^\p{L}/,'u').test(char); }
	...
	static isName(name: string, strict: boolean = true): boolean {
	...
	static serialize(data: any = {}, params: any): any {
		
		if (params == "JSON") return JsonSerializer.serialize(data);
