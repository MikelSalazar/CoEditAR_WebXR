/******************************************************************************
 CoEditAR Build System
 This NodeJS script manages the build system.
******************************************************************************/
...
global.EXTERNALS_FOLDER_PATH = BUILDS_FOLDER_PATH + 'external\\';
...
let options = {
	...
	verbose: true,	// Indicates whether the verbose mode is enabled or not
};
