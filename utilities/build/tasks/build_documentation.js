...
function createJsonFile() {
	...
	let data = { name: FRAMEWORK_NAME, classes: {}, files: {} };
	let tab = "\t";
...
function createAsciiDocFile() {
	...
	writeHeader(FRAMEWORK_NAME + ' Class Reference');
...
function createHtmlFile() {
	...
	let title = FRAMEWORK_NAME + ' Class Reference';
	...
	createCssRule('section hr', { max_width: '60vh', margin: '2vh auto', 
		color: emphasisColor}) ;
